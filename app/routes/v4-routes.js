...
router.post('/v4/sign-in-password', function (req, res) {
  ...
  if (req.session.data['signin-password'] === '') {
    ...
    // User inputted value so move to next page
    res.redirect('/v4/ch-verified')
  }
})


// ******* ch-verified javascript ********************************
router.get('/v4/ch-verified', function (req, res) {
  // Set URl
...
router.post('/v4/ch-verified', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v4/how-verify', function (req, res) {
  // Set URl
...
router.post('/v4/how-verify', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['how-did-you-verify'] === 'undefined') {
    ...
    if (req.session.data['how-did-you-verify'] === 'onelogin') {
      res.redirect('/v4/sign-in-verified')
    }
    else {
      res.redirect('/v4/uvid')
    }
  }
})

// ******* how-verify javascript ********************************
router.get('/v4/dob', function (req, res) {
  // Set URl
  res.render('v4/dob', {
    currentUrl: req.originalUrl
  })
...
router.post('/v4/dob', function (req, res) {
    // Create empty array and set error variables to false
    var errors = []
  ...
  if (dobError) {
    ...
    if (req.session.data['uvid'] === 'xxxx') {
      res.redirect('/v4/acsp-not-verified')
    }
    else {
      res.redirect('/v4/acsp-verified')
    }
  }
})
...
// ******* uvid validation ********************************
router.get('/v4/uvid', function (req, res) {
  // Set URl
  res.render('v4/uvid', {
    currentUrl: req.originalUrl
  })
...
router.post('/v4/uvid', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
...
// ******* sign-in-verified ********************************
router.get('/v4/sign-in-verified', function (req, res) {
  // Set URl
...
router.post('/v4/sign-in-verified', function (req, res) {
  res.redirect('/v4/verify-create-or-sign-in')
})


// ******* verified-email ********************************
router.get('/v4/verified-email', function (req, res) {
  // Set URl
...
router.post('/v4/verified-email', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
  ...
  if (req.session.data['verified-email'] === '') {
    ...
    // User inputted value so move to next page
    res.redirect('/v4/verified-password')
  }
})


// ******* verified-password ********************************
router.get('/v4/verified-password', function (req, res) {
  // Set URl
...
router.post('/v4/verified-password', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
  ...
  if (req.session.data['verified-password'] === '') {
    ...
    if (req.session.data['verified-password'] == 'password' ) {
      res.redirect('/v4/verified')
    } else {
      // User inputted value so move to next page
      res.redirect('/v4/not-verified')
    }
  }
})
